...
class TestPgnReader(unittest.TestCase):
    def _assert_piece(self, piece, expected_cls, expected_color, expected_position):
        self.assertIsInstance(piece, expected_cls)
        self.assertEqual(piece.color, expected_color)
        if expected_position is None:
            self.assertIsNone(piece.position)
        else:
            self.assertEqual(piece.position, expected_position)
    ...
    def test_get_piece_from_char_accepts_short_color_names(self):
        ...
        self._assert_piece(start_piece, pieces.Pawn, pieces.Color.WHITE, pieces.VirtualPosition())
        self._assert_piece(end_piece, pieces.Pawn, pieces.Color.WHITE, pieces.Position.from_string("e4"))
    ...
    def test_get_piece_from_char_accepts_short_color_names_for_castling(self):
        ...
        self._assert_piece(start_piece, pieces.King, pieces.Color.BLACK, pieces.Position(5, 8))
        self._assert_piece(end_piece, pieces.King, pieces.Color.BLACK, pieces.Position(7, 8))

    def test_get_piece_from_char_keeps_origin_file_hint(self):
        start_piece, end_piece = pgn_reader.get_piece_from_char("Nbd2", "white")
        self._assert_piece(start_piece, pieces.Knight, pieces.Color.WHITE, pieces.VirtualPosition(file=2))
        self._assert_piece(end_piece, pieces.Knight, pieces.Color.WHITE, pieces.Position.from_string("d2"))

    def test_get_piece_from_char_keeps_origin_rank_hint(self):
        start_piece, end_piece = pgn_reader.get_piece_from_char("R1e1", "white")
        self._assert_piece(start_piece, pieces.Rook, pieces.Color.WHITE, pieces.VirtualPosition(rank=1))
        self._assert_piece(end_piece, pieces.Rook, pieces.Color.WHITE, pieces.Position.from_string("e1"))
    ...
    def test_get_piece_from_char_keeps_full_origin_when_present(self):
        ...
        self._assert_piece(start_piece, pieces.Queen, pieces.Color.WHITE, pieces.Position.from_string("h4"))
        self._assert_piece(end_piece, pieces.Queen, pieces.Color.WHITE, pieces.Position.from_string("e1"))
    ...
    def test_get_piece_from_char_keeps_promotion_origin_hint(self):
        ...
        self._assert_piece(start_piece, pieces.Pawn, pieces.Color.WHITE, pieces.VirtualPosition(file=5))
        self._assert_piece(end_piece, pieces.Queen, pieces.Color.WHITE, pieces.Position.from_string("d8"))
    ...
    def test_get_piece_from_char_parses_normal_piece_move_without_disambiguation(self):
        ...
        self._assert_piece(start_piece, pieces.Knight, pieces.Color.WHITE, pieces.VirtualPosition())
        self._assert_piece(end_piece, pieces.Knight, pieces.Color.WHITE, pieces.Position.from_string("f3"))

    def test_get_piece_from_char_parses_pawn_capture(self):
        start_piece, end_piece = pgn_reader.get_piece_from_char("exd5", "white")
        self._assert_piece(start_piece, pieces.Pawn, pieces.Color.WHITE, pieces.VirtualPosition(file=5))
        self._assert_piece(end_piece, pieces.Pawn, pieces.Color.WHITE, pieces.Position.from_string("d5"))

    def test_get_piece_from_char_parses_piece_capture(self):
        start_piece, end_piece = pgn_reader.get_piece_from_char("Qxe5", "black")
        self._assert_piece(start_piece, pieces.Queen, pieces.Color.BLACK, pieces.VirtualPosition())
        self._assert_piece(end_piece, pieces.Queen, pieces.Color.BLACK, pieces.Position.from_string("e5"))

    def test_get_piece_from_char_ignores_check_suffix(self):
        start_piece, end_piece = pgn_reader.get_piece_from_char("Qh5+", "white")
        self._assert_piece(start_piece, pieces.Queen, pieces.Color.WHITE, pieces.VirtualPosition())
        self._assert_piece(end_piece, pieces.Queen, pieces.Color.WHITE, pieces.Position.from_string("h5"))

    def test_get_piece_from_char_ignores_mate_suffix(self):
        start_piece, end_piece = pgn_reader.get_piece_from_char("Qh7#", "white")
        self._assert_piece(start_piece, pieces.Queen, pieces.Color.WHITE, pieces.VirtualPosition())
        self._assert_piece(end_piece, pieces.Queen, pieces.Color.WHITE, pieces.Position.from_string("h7"))
    ...
    def test_get_piece_from_char_ignores_annotation_suffix(self):
        ...
        self._assert_piece(start_piece, pieces.Bishop, pieces.Color.WHITE, pieces.VirtualPosition())
        self._assert_piece(end_piece, pieces.Bishop, pieces.Color.WHITE, pieces.Position.from_string("b5"))
    ...
    def test_get_piece_from_char_ignores_combined_capture_check_and_annotation(self):
        ...
        self._assert_piece(start_piece, pieces.Knight, pieces.Color.WHITE, pieces.VirtualPosition())
        self._assert_piece(end_piece, pieces.Knight, pieces.Color.WHITE, pieces.Position.from_string("f7"))
    ...
    def test_get_piece_from_char_parses_white_queenside_castling(self):
        ...
        self._assert_piece(start_piece, pieces.King, pieces.Color.WHITE, pieces.Position(5, 1))
        self._assert_piece(end_piece, pieces.King, pieces.Color.WHITE, pieces.Position(3, 1))
    ...
    def test_get_piece_from_char_parses_black_queenside_castling_with_lowercase_o(self):
        ...
        self._assert_piece(start_piece, pieces.King, pieces.Color.BLACK, pieces.Position(5, 8))
        self._assert_piece(end_piece, pieces.King, pieces.Color.BLACK, pieces.Position(3, 8))

    def test_get_piece_from_char_parses_simple_promotion(self):
        start_piece, end_piece = pgn_reader.get_piece_from_char("e8=Q", "white")
        self._assert_piece(start_piece, pieces.Pawn, pieces.Color.WHITE, pieces.VirtualPosition())
        self._assert_piece(end_piece, pieces.Queen, pieces.Color.WHITE, pieces.Position.from_string("e8"))
    ...
    def test_get_piece_from_char_parses_promotion_to_knight_after_capture(self):
        ...
        self._assert_piece(start_piece, pieces.Pawn, pieces.Color.WHITE, pieces.VirtualPosition(file=5))
        self._assert_piece(end_piece, pieces.Knight, pieces.Color.WHITE, pieces.Position.from_string("d8"))
    ...
    def test_get_piece_from_char_parses_promotion_with_mate_suffix(self):
        ...
        self._assert_piece(start_piece, pieces.Pawn, pieces.Color.WHITE, pieces.VirtualPosition(file=6))
        self._assert_piece(end_piece, pieces.Rook, pieces.Color.WHITE, pieces.Position.from_string("g8"))
    ...
    def test_get_piece_from_char_keeps_full_origin_for_knight_move(self):
        ...
        self._assert_piece(start_piece, pieces.Knight, pieces.Color.WHITE, pieces.Position.from_string("b1"))
        self._assert_piece(end_piece, pieces.Knight, pieces.Color.WHITE, pieces.Position.from_string("d2"))
    ...
    def test_get_piece_from_char_returns_virtual_origin_for_simple_pawn_move(self):
        ...
        self._assert_piece(start_piece, pieces.Pawn, pieces.Color.WHITE, pieces.VirtualPosition())
        self._assert_piece(end_piece, pieces.Pawn, pieces.Color.WHITE, pieces.Position.from_string("a4"))
    ...
    def test_get_piece_from_char_currently_accepts_out_of_range_rank_hint_nine(self):
        ...
        self._assert_piece(start_piece, pieces.Rook, pieces.Color.WHITE, pieces.VirtualPosition(rank=9))
        self._assert_piece(end_piece, pieces.Rook, pieces.Color.WHITE, pieces.Position.from_string("e1"))
    ...
    def test_get_piece_from_char_currently_accepts_out_of_range_rank_hint_zero(self):
        ...
        self._assert_piece(start_piece, pieces.Rook, pieces.Color.WHITE, pieces.VirtualPosition(rank=0))
        self._assert_piece(end_piece, pieces.Rook, pieces.Color.WHITE, pieces.Position.from_string("e1"))
